...
import br.com.professorallocation.databinding.ActivityProfessorsBinding;
...
public class ProfessorsActivity extends AppCompatActivity {
    ...
    private ActivityProfessorsBinding viewBinding;
    private RetrofitConfig retrofitConfig;
    private ProfessorAdapter adapter;

    @Override
    protected void onResume(){
        requestCarregarTodosOsProfessors();
        super.onResume();
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewBinding = ActivityProfessorsBinding.inflate(getLayoutInflater());
        ...
        viewBinding.rvListaProfessors.setAdapter(this.adapter);
    ...
    private void dialogConfirmation(Professor professor) {
        ...
        msgBox.setNegativeButton("No", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                Toast.makeText(ProfessorsActivity.this, "Delete Canceled.", Toast.LENGTH_SHORT).show();
            }
        });
        msgBox.show();
    }
    ...
    private void requestDelete(Professor professor){
        ...
        service.delete(professor.getId()).enqueue(new Callback() {
            ...
            public void onFailure(Call call, Throwable t) {
                Log.e(ProfessorsActivity.class.getSimpleName(),"Comunication error, " + t.getMessage());
    ...
    private void requestCarregarTodosOsProfessors(){
            ...
            public void onResponse(Call<List<Professor>> call, Response<List<Professor>> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    for (Professor professor: list) {
                        Log.d(ProfessorsActivity.class.getSimpleName(), professor.getName());
                        Log.d(ProfessorsActivity.class.getSimpleName(), professor.getCpf());
                        Log.d(ProfessorsActivity.class.getSimpleName(), String.valueOf(professor.getDepartmentId()));
                    }
                }else{
